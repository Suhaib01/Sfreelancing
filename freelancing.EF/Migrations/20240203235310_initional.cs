        ...
        protected override void Up(MigrationBuilder migrationBuilder)
        {
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    StudantOrTeacher = table.Column<string>(type: "nvarchar(max)", nullable: true),
                    IsCompleted = table.Column<bool>(type: "bit", nullable: true),
                    IDFrontImage = table.Column<string>(type: "nvarchar(max)", nullable: true),
                    IsExternal = table.Column<string>(type: "nvarchar(max)", nullable: true),
                    IDbackImage = table.Column<string>(type: "nvarchar(max)", nullable: true),
                    IsRejectedUser = table.Column<bool>(type: "bit", nullable: false),
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    PersonMajor = table.Column<string>(type: "nvarchar(max)", nullable: true),
                    PersonTestimonial = table.Column<string>(type: "nvarchar(max)", nullable: true)
                },
                constraints: table =>
                {
            ...
            migrationBuilder.CreateTable(
                ...
                constraints: table =>
                {
                    table.PrimaryKey("PK_WAWS", x => x.Id);
                });
